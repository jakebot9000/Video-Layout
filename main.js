...
function loadModuleHandler() {
  ...
  //JAKE!
  config.declare('PanelBackground', {
    'backgroundImage': {
      '@type': 'color' //JAKE! Why doesn't image work in local mode??
    }
  });
  ...
  config.declare('Main', {
    ...
    'background': { '@type': 'PanelBackground' }
  });
...
function backgroundListener(value) {
